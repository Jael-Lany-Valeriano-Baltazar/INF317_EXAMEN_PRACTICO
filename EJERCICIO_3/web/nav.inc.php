    ...
    <nav class="navbar navbar-expand-md navbar-dark navbar-custom fixed-top">
        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link page-scroll" href="#services">ACADÉMICO</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link page-scroll" href="#services" style="background-color:#f1bf7d62; border-radius: 30px;">
                        <img src="../logos/perfil.png" alt="">
