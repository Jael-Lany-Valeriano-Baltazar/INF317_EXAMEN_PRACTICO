<?php 
    ...
    $QUERYES = mysqli_query($con,"SELECT ROL FROM USUARIO WHERE USUARIO = '$USER'");
    ...
    <nav class="navbar navbar-expand-md navbar-dark navbar-custom fixed-top">
        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a class="nav-link page-scroll" href="inicioNotas.php">INICIO<span class="sr-only">(current)</span></a>
                </li>
                <!--<li class="nav-item">
