...
<div class="card row align-items-center">
    <div class="card-body col ">
        ...
        <input type="text" name="ci" id="ci" class="form-control" placeholder="" aria-describedby="helpId">
        </div>
        ...
        <input type="date" name="fec" id="fec" class="form-control" placeholder="" aria-describedby="helpId">
        </div>
        <div class="col-8 mb-3">
        ...
        <input type="text" size="2" name="depa" id="depa" class="form-control" placeholder="LP" aria-describedby="helpId">
        <br> 
